...
var parameters = {
  truncHeight:args.number+80,
  truncThickness:2,
  truncColor:Colors.grey_d,
  truncNoise:2,
  foliageColor:"pinks",
  foliageDensity:args.number,
  foliageNoise:.1,
  foliageSize : 5+0.4*args.number,
  animationSpeed: 2.5,
};
...
function initGUI(){
  ...
  gui.add(parameters, 'foliageDensity').min(0).max(50).step(1).name('Foliage Density');
